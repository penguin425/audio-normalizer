...
cp schema/adm-presentation-report-v1.schema.json \
   schema/adm-interactivity-report-v1.schema.json "$staging/schema/"
...
cp README.md CHANGELOG.md COMPATIBILITY.md CONTRIBUTING.md SECURITY.md DOCUMENTATION.md \
   ...
   MPEGH-ADAPTER.md DTS-ADAPTER.md ADM-PRESENTATION-QC.md ADM-INTERACTIVITY-QC.md ANOMALY-ADAPTER.md \
