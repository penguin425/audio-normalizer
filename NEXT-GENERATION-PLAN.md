...
| 7 | Streaming C ABI contract (7a), then FFmpeg and GStreamer integration adapters (7b) over the live processor | Define frame/latency/flush semantics first; ABI tests and Linux package smoke tests. |
