...
main analysis, stable-input/bound-analysis, normalization, generation,
runtime-fingerprint, WAV, preset, and real-time entry points. It complements
structural API inspection with ordinary consumer code.
